...
A relationship instance can be deleted in the same way that an object instance can with `delete_𝘳𝘦𝘭𝘢𝘵𝘪𝘰𝘯𝘴𝘩𝘪𝘱 𝘯𝘢𝘮𝘦(𝘳𝘦𝘭𝘢𝘵𝘪𝘰𝘯𝘴𝘩𝘪𝘱 𝘯𝘢𝘮𝘦_id)` Additionally, if any of the object instances linked by a relationship instance with type `unique` or `many` links are deleted, then the relationship instance will automatically be deleted as well.
