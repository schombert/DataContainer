...
namespace ve {
	...
	struct value_to_vector_type_s<cob2::car_id> {
		using type = ::ve::tagged_vector<cob2::car_id>;
	};
	
	template<>
	struct value_to_vector_type_s<cob2::person_id> {
		using type = ::ve::tagged_vector<cob2::person_id>;
	};
	
	template<>
	struct value_to_vector_type_s<cob2::car_ownership_id> {
		using type = ::ve::tagged_vector<cob2::car_ownership_id>;
	};
