...
DCON_LUADLL_API int32_t dcon_pop_get_range_negotiation_as_initiator(int32_t i); 
DCON_LUADLL_API int32_t dcon_pop_get_index_negotiation_as_initiator(int32_t i, int32_t subindex); 
DCON_LUADLL_API int32_t dcon_pop_get_range_negotiation_as_target(int32_t i); 
DCON_LUADLL_API int32_t dcon_pop_get_index_negotiation_as_target(int32_t i, int32_t subindex); 
